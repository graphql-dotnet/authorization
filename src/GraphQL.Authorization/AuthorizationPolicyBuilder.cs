...
namespace GraphQL.Authorization
{
    ...
    public class AuthorizationPolicyBuilder
    {
        ...
        {
            _requirements.Add(new ClaimsAuthorizationRequirement(claimType));
            return this;
        }
        ...
        {
            _requirements.Add(new ClaimsAuthorizationRequirement(claimType, allowedValues, displayValues));
            return this;
        }
