...
export default function version() {
  ...
  return gitCommit().then(commit => {
    ...
    const options = {
      description: 'A toolset for authorizing access to graph types for GraphQL .NET',
      productName: 'GraphQL.Authorization',
      copyright: 'Copyright 2017 Joseph T. McBride et al.  All rights reserved.',
      trademark: commit,
